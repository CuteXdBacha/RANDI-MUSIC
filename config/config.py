...
BOT_TOKEN = getenv("BOT_TOKEN", "5888890044:AAFQHs8aQvUceFPByKeDlCt5fPzSxsyo4ys")
...
DURATION_LIMIT_MIN = int(
    getenv("DURATION_LIMIT", "60000000000000000000")
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "5548606006").split())
